...
//.		def("GetFontHeaderEurope",		&GetFontHeaderEurope),
		...
		.def("SetCenterFromScreen",		&CUIWindow::SetCenterFromScreen)
		.def("IsWndPosFromCenter",		&CUIWindow::IsCenterFromScreen)
...
//		.def("",						&CUIWindow::)
		...
		.def("SetBaseTextureColor",		&CUIFrameWindow::SetBaseTextureColor)
		.def("GetTitleStatic",			&CUIFrameWindow::GetTitleStatic)
		.def("SetWndPosFromCenter",		&CUIFrameWindow::SetCenterFromScreen)
		.def("IsWndPosFromCenter",		&CUIFrameWindow::IsCenterFromScreen)
		...
		.def("SetBaseTextureColor",				&CUIFrameLineWnd::SetBaseTextureColor)
